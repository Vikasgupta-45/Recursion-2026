...
import { BrainCircuit, CalendarClock, WandSparkles } from 'lucide-react';
...
const Register = () => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    navigate('/dashboard'); // simulate registration
  };
      ...
      <div className="auth-layout">
        ...
        >
          ...
          <p style={{ marginTop: 16, maxWidth: 480, color: 'rgba(255,255,255,0.8)' }}>
            Connect your channel, generate predictive strategies, and get clear next steps to increase views and retention.
          </p>
